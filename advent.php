    ...
    try {
        ...
        if ($c == $day) {
            ...
            switch ($day){
                ...
                case 4:{
                    if (addService(21, 3)) {
                        echo '<p>Ajándék 1 hónap szén csomagot kaptál.</p>';
                    } else {
                        echo '<p class="error">Nem sikerült jóváírnunk az ajándék 1 hónap szén csomagodat, kérlek írj egy hibajegyet.</p>';
                    }
                    return;
                }
                case 5:{
...
function makeButtons()
{
    global $day;
    for ($c = 1; $c <= 24; ++$c) {
        echo $c == $day ? "<a href = \"advent.php?click=" . $c . "\" >
